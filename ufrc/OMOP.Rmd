...
rm(concept_ancestor_merged)

# list the concept-ids from Conditions Concept Dataset
concept_id=concept_vocab_filter_new$CONCEPT_ID

# filter out the Descendant_concept_id that DONT MATCH the concept-ids from above

concept_ancestor_vocab_merged_trim=concept_ancestor_vocab_merged %>%
